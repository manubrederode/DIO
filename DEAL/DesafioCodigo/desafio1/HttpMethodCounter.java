...
public class HttpMethodCounter {
    public static String findMostFrequentMethod(String input) {
        ...
        // Conta a ocorrência de cada método HTTP e armazenar no mapa 'methodCounts'
        for (String method : methods) {
            method = method.trim().toUpperCase(); // Remove espaços extras e converte para maiúsculas
